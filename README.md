...
To train my neural network, I used the dataset available at http://www.pjreddie.com/media/files/mnist_train.csv which contains 60,000 images. I used approximately 50,000 images from this dataset to train my NN, and the test dataset contains 10,000 records. After five epochs of training, the model achieved an accuracy of about 95%.
